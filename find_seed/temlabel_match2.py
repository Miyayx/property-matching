...
ENWIKI_INFOBOX = "/data/xlore20160223/wikiExtractResult/enwiki-infobox-tmp.dat"
ZHWIKI_INFOBOX = "/data/xlore20160223/wikiExtractResult/zhwiki-infobox-tmp.dat"
...
enwiki_infobox_tem = {k: v for k, v in enwiki_infobox_tem.iteritems() if k in set(matched_ins.keys())}
enwiki_infobox_tem = {k: v for k, v in enwiki_infobox_tem.iteritems() if k in set(matched_ins.keys())}

zhwiki_infobox_tem = {k: v for k, v in zhwiki_infobox_tem.iteritems() if k in set(matched_ins.values())}
zhwiki_infobox_tem = {k: v for k, v in zhwiki_infobox_tem.iteritems() if k in set(matched_ins.values())}
